...
- `src/sessionDiffTracker.ts` owns per-session changed-line baselines and net line diff stats for files modified through Pi edit/write tool executions; do not replace this with git diff for the sidebar counter.
